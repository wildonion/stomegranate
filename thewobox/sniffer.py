...
# sniffer python based

'''
sniff all students of umz with this script in cs aquarium and dormitory studing room
create a packet sniffer like the one ISPs using in python to filter web content, 
block sites and other kind of filtering like closing ports on my own network using my packet sniffer script!
build my own portscanner like nmap but more powerful than that and support NSE
...
https://www.packtpub.com/mapt/book/networking_and_servers/9781784399771/7/ch07lvl1sec41/packet-sniffer-in-python
https://null-byte.wonderhowto.com/how-to/build-dns-packet-sniffer-with-scapy-and-python-0163601/
https://medium.com/python-pandemonium/using-pyshark-in-python-to-create-promiscuous-sniffer-ddb5217f3d5
